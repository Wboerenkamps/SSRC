...
SSRC::SSRC() {
    // motorToEncoderMap[0x63] = 3; // m1 = x0 encoder = 0 -- m/e werkend
    // motorToEncoderMap[0x68] = 1; // m2 = 11 encoder = 2 niet
    // motorToEncoderMap[0x64] = 2; // m3 = xx encoder = 1 -- e werkend
    // motorToEncoderMap[0x65] = 1; // m4 = 00 encoder niet 
